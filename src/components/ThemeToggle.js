import { toggleTheme, isDarkMode } from "../utils/theme.js";

export function createThemeToggle() {
  const btn = document.createElement("button");
  btn.className = "p-1.5 rounded-xl text-neutral-400 hover:text-neutral-100 hover:bg-neutral-500/10 transition-colors focus:outline-none";
